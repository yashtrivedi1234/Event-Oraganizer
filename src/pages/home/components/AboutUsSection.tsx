    ...
    <section className="section-padding bg-background px-6 md:px-12" data-scroll-section>
      <div className="max-w-7xl mx-auto">
        <motion.div
          ...
          className="relative overflow-hidden rounded-[28px] border border-white/10 bg-black shadow-[0_30px_120px_rgba(0,0,0,0.45)]"
        >
          <div
          ...
          <div className="relative z-10 flex items-center justify-end p-4 md:p-6">
            <motion.div
            ...
            >
              ...
              <h2 className="h2 mb-3 text-white">
                A New Standard Of Celebration
              </h2>
              <p className="p mb-4 max-w-xl text-white/85 text-sm">
              ...
              <div className="mb-4 grid grid-cols-2 gap-3 text-white/80">
                <div className="rounded-2xl border border-white/10 bg-black/20 p-3">
                  ...
                  <p className="mt-0.5 text-xs uppercase tracking-[0.3em]">Events Produced</p>
                </div>
                <div className="rounded-2xl border border-white/10 bg-black/20 p-3">
                  <p className="font-semibold text-white">24</p>
                  <p className="mt-0.5 text-xs uppercase tracking-[0.3em]">Countries Reached</p>
                </div>
              </div>
